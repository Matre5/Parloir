...
from app.routers import auth, chat, profile, translate, word, essays, comprehension
...
app.include_router(comprehension.router, prefix="/api/comprehension", tags=["Comprehension"])
